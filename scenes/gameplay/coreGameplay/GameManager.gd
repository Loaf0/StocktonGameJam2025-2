...
@export_dir var minigames_dir: String = "res://scenes/gameplay/minigames/"
@export var transition_scene: PackedScene = preload("res://scenes/gameplay/transitions/JailTransition.tscn")
@export var flavor_scene: PackedScene = preload("res://scenes/gameplay/animations/TestAnimation.tscn")
